...
import 'package:upskillingproject/Payment/SelectingHoursMenu.dart';
import 'package:upskillingproject/Payment/Validation.dart';
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      if (_validation.validVehiclePlate(vechileIDController.text) && _validation.validAreaID(areaIDController.text)) {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
